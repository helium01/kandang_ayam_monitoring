...
<link id="pagestyle" href="{{asset("asset")}}/assets/css/material-dashboard.css?v=3.1.0" rel="stylesheet" />
...
<script defer data-site="YOUR_DOMAIN_HERE" src="https://api.nepcha.com/js/nepcha-analytics.js"></script>
  ...
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
      ...
      <span class="ms-1 font-weight-bold text-white">Monitoring Kandang</span>
    </a>
  </div>
...
<li class="nav-item">
  <a class="nav-link text-white " href="/ayams">
    ...
    <span class="nav-link-text ms-1">Ayam</span>
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link text-white " href="/dht">
    ...
    <span class="nav-link-text ms-1">Suhu Kelembapan</span>
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link text-white " href="/ldr">
    ...
    <span class="nav-link-text ms-1">Cahaya</span>
  </a>
</li>

<li class="nav-item">
  <a class="nav-link text-white " href="/gas">
...
<li class="nav-item">
  <a class="nav-link text-white " href="/rtc">
    ...
    <span class="nav-link-text ms-1">Realtime Waktu COntroller</span>
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link text-white " href="/saklars">
    ...
    <span class="nav-link-text ms-1">Saklar</span>
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link text-white " href="/servos">
    ...
    <span class="nav-link-text ms-1">Makan / Minum</span>
  </a>
</li>
...
<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc --><script src="{{asset("asset")}}/assets/js/material-dashboard.min.js?v=3.1.0"></script>
  </body>
